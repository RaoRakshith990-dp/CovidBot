...
public class SpAdapter extends RecyclerView.Adapter<SpAdapter.ViewHolder> {
    private List<SpecialItem> listItems;
    private Context context;

    public SpAdapter(Context context, List<SpecialItem> listItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.special_item, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final SpecialItem listItem=listItems.get(position);
        holder.spec.setText(listItem.getSpeciality());
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            spec= itemView.findViewById(R.id.special);
